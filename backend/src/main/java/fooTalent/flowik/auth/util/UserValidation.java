...
public class UserValidation {
    ...
    public AuthResponse validate(User user) {
        ...
        if (user.getPassword() == null || !user.getPassword().matches(PASSWORD_REGEX)) {
            return new AuthResponse(null, "La contraseña debe tener entre 8 y 16 caracteres, al menos un número, una minúscula, una mayúscula y un caracter especial.", false);
        }
