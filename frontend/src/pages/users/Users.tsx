      ...
      <div className="mx-auto w-full max-w-[1400px]">
        <header className="mb-8 flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-5 py-4">
          <div className="flex items-center gap-3">
            <span className="rounded-full bg-slate-100 p-3 text-slate-700 shadow-lg">
        ...
        <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg">
          <div className="p-6">
            <h2 className="mb-3 text-lg font-bold text-slate-900">Usuarios Registrados</h2>
            ...
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <div className="relative w-full max-w-xs">
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white py-2 pr-3 pl-9 text-sm text-slate-700 placeholder:text-slate-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableHeader>
                  <TableRow>
                    <TableHead className="bg-slate-50 text-slate-500">ID</TableHead>
                    <TableHead className="bg-slate-50 text-slate-500">Nombre</TableHead>
                    <TableHead className="bg-slate-50 text-slate-500">Apellido</TableHead>
                    <TableHead className="bg-slate-50 text-slate-500">Email</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
            ...
            <div className="flex items-center justify-center gap-6 border-t border-slate-200 px-4 py-3">
              <button
                type="button"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-300 bg-white hover:bg-slate-100 disabled:cursor-not-allowed"
                aria-label="Anterior"
