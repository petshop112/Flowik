...
const EmptyProvidersState: React.FC<{ onAddClient: () => void }> = ({ onAddClient }) => {
  return (
    <article className="flex min-h-96 flex-col items-center justify-center py-12 text-center">
      ...
      <p className="mb-6 max-w-md text-gray-500">
        Comienza agregando tu primer proveedor para gestionar tu cartera y operaciones de manera
        eficiente.
      </p>
      <button
        onClick={onAddClient}
